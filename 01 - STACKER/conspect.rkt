...
6. Expander
  ...
  Задачи Экспандера:
  - Предоставлять отдельный макрос, #%module-begin - done
  - Реализовывать стек функций, с интерфейсом хранения, считывания и обработки
  - Предоставлять байндинги для трех идентификаторов

7. ВЫВОДЫ
  - A language developed on Racket is a variant of source-to-source compiler
  - Every lang has a reader and an expander. A reader resp for design, expander - for the meaning.
  - Your lang converted into set of S-expressions